...
INSERT INTO YADA_QUERY_CONF (APP,CONF) VALUES ('BLS','http://api.bls.gov/publicAPI/v1/timeseries/data/');  --Gas prices
INSERT INTO YADA_QUERY_CONF (APP,CONF) VALUES ('NOAA','jdbcUrl=jdbc:sqlite:/Users/varonda1/Documents/workspace-git/yadademo/src/main/resources/db/Weather.db
autoCommit=true
...
driverClassName=org.sqlite.JDBC'); --Weather data
